...
public class Ball{
    ...
    //Points scored for different balls
    private int score;
    ...
    /**
     * add the lives of the ball when undo
     */
    public void addLives(){
        this.strategy.addLives();
    }
     ...
     * @return true if the ball is capable of being active
     */
     ...
     * @param active true if the ball is capable of being active
     */
