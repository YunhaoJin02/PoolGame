...
//        pockets.add(new Pocket(10, 10,15));
//        pockets.add(new Pocket(xLength - 10, 10,15));
//        pockets.add(new Pocket(xLength / 2, 10,15));
//        pockets.add(new Pocket(10, yLength - 10,15));
//        pockets.add(new Pocket(xLength - 10, yLength - 10,15));
//        pockets.add(new Pocket(xLength / 2, yLength - 10,15));
//    }
}
